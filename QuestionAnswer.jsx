        ...
        <div key={index + Math.random()} className={item.type == 'q' ? 'flex justify-end' : ''}>
                  {item.type == 'q' ?
                    <li key={index + Math.random()}
                      className='text-right p-1 border-8  dark:bg-zinc-700 dark:border-zinc-700 bg-gray-200 border-gray-200 text-black dark:text-zinc-200 rounded-tl-3xl rounded-bl-3xl rounded-br-3xl w-fit'
